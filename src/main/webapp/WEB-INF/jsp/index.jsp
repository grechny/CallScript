            ...
            <form:form action="/add" method="post" modelAttribute="formDTO">
                ...
                <div id="yesterdayListen1Div" hidden>
                    ...
                    <div id="whatRadioListen1">
                        ...
                        <div id="formwhatRadioListen14Div" hidden><input id="formwhatRadioListen14" name="form[whatRadioListen1]" type="checkbox" value="4"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen14">4. Минская Волна 97,4</label><br></div>
                        <div id="formwhatRadioListen15Div" hidden><input id="formwhatRadioListen15" name="form[whatRadioListen1]" type="checkbox" value="5"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen15">5. Новое Радио 98,4</label><br></div>
                        <div id="formwhatRadioListen16Div" hidden><input id="formwhatRadioListen16" name="form[whatRadioListen1]" type="checkbox" value="6"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen16">6. Русское Радио Минск 98,9</label><br></div>
                        <div id="formwhatRadioListen17Div" hidden><input id="formwhatRadioListen17" name="form[whatRadioListen1]" type="checkbox" value="7"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen17">7. Радио UNISTAR 99,5</label><br></div>
                        <div id="formwhatRadioListen18Div" hidden><input id="formwhatRadioListen18" name="form[whatRadioListen1]" type="checkbox" value="8"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen18">8. Хит-Радио 100,4</label><br></div>
                        ...
                        <div id="formwhatRadioListen110Div" hidden><input id="formwhatRadioListen110" name="form[whatRadioListen1]" type="checkbox" value="10"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen110">10. Радио ОНТ 101,7</label><br></div>
                        <div id="formwhatRadioListen111Div" hidden><input id="formwhatRadioListen111" name="form[whatRadioListen1]" type="checkbox" value="11"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen111">11. Радио РОКС 102,1</label><br></div>
                        <div id="formwhatRadioListen112Div" hidden><input id="formwhatRadioListen112" name="form[whatRadioListen1]" type="checkbox" value="12"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen112">12. Народное радио 102,5</label><br></div>
                        <div id="formwhatRadioListen113Div" hidden><input id="formwhatRadioListen113" name="form[whatRadioListen1]" type="checkbox" value="13"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen113">13. Культура 102,9</label><br></div>
                        <div id="formwhatRadioListen114Div" hidden><input id="formwhatRadioListen114" name="form[whatRadioListen1]" type="checkbox" value="14"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen114">14. Радиус FM 103,7</label><br></div>
                        <div id="formwhatRadioListen115Div" hidden><input id="formwhatRadioListen115" name="form[whatRadioListen1]" type="checkbox" value="15"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen115">15. Радио Би-Эй 104,6</label><br></div>
                        <div id="formwhatRadioListen116Div" hidden><input id="formwhatRadioListen116" name="form[whatRadioListen1]" type="checkbox" value="16"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen116">16. Столица 105,1</label><br></div>
                        <div id="formwhatRadioListen117Div" hidden><input id="formwhatRadioListen117" name="form[whatRadioListen1]" type="checkbox" value="17"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen117">17. Душевное радио 105,7</label><br></div>
                        <div id="formwhatRadioListen118Div" hidden><input id="formwhatRadioListen118" name="form[whatRadioListen1]" type="checkbox" value="18"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen118">18. 1-й Национальный канал белорусского радио 106,2</label><br></div>
                        <div id="formwhatRadioListen119Div" hidden><input id="formwhatRadioListen119" name="form[whatRadioListen1]" type="checkbox" value="19"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen119">19. Легенды FM 94,1</label><br></div>
                        <div id="formwhatRadioListen120Div" hidden><input id="formwhatRadioListen120" name="form[whatRadioListen1]" type="checkbox" value="20"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen120">20. Радио Мир 107,1</label><br></div>
                        <div id="formwhatRadioListen121Div" hidden><input id="formwhatRadioListen121" name="form[whatRadioListen1]" type="checkbox" value="21"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen121">21. Альфа радио 107,9</label><br></div>
                        <div id="formwhatRadioListen122Div" hidden><input id="formwhatRadioListen122" name="form[whatRadioListen1]" type="checkbox" value="23"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen122">23. Город FM (Брест) 97,7</label><br></div>
                        <div id="formwhatRadioListen123Div" hidden><input id="formwhatRadioListen123" name="form[whatRadioListen1]" type="checkbox" value="24"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen123">24. Радио Брест 104,8</label><br></div>
                        <div id="formwhatRadioListen124Div" hidden><input id="formwhatRadioListen124" name="form[whatRadioListen1]" type="checkbox" value="25"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen124">25. Русское Радио Витебск 89,5</label><br></div>
                        <div id="formwhatRadioListen125Div" hidden><input id="formwhatRadioListen125" name="form[whatRadioListen1]" type="checkbox" value="26"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen125">26. Радио Витебск 91,2</label><br></div>
                        <div id="formwhatRadioListen126Div" hidden><input id="formwhatRadioListen126" name="form[whatRadioListen1]" type="checkbox" value="27"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen126">27. Европа Плюс (Витебск) 97,8</label><br></div>
                        <div id="formwhatRadioListen127Div" hidden><input id="formwhatRadioListen127" name="form[whatRadioListen1]" type="checkbox" value="28"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen127">28. Ретро Люкс FM (Витебск) 104,6</label><br></div>
                        <div id="formwhatRadioListen128Div" hidden><input id="formwhatRadioListen128" name="form[whatRadioListen1]" type="checkbox" value="29"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen128">29. Гомель FM 101,3</label><br></div>
                        <div id="formwhatRadioListen139Div" hidden><input id="formwhatRadioListen129" name="form[whatRadioListen1]" type="checkbox" value="30"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen129">30. Гомель Плюс 103,7</label><br></div>
                        <div id="formwhatRadioListen130Div" hidden><input id="formwhatRadioListen130" name="form[whatRadioListen1]" type="checkbox" value="31"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen130">31. Гомельское городское радио 107,4</label><br></div>
                        <div id="formwhatRadioListen132Div" hidden><input id="formwhatRadioListen132" name="form[whatRadioListen1]" type="checkbox" value="32"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen132">32. Радио Гродно 101,2</label><br></div>
                        <div id="formwhatRadioListen133Div" hidden><input id="formwhatRadioListen133" name="form[whatRadioListen1]" type="checkbox" value="33"><input type="hidden" name="_form[whatRadioListen1]" value="on"><label for="formwhatRadioListen133">33. Радио MFM (Гродно) 105,0</label><br></div>
                ...
                <div id="yesterdayListen2Div" hidden>
                    ...
                    <div id="whatRadioListen2">
                        ...
                        <div id="formwhatRadioListen24Div" hidden><input id="formwhatRadioListen24" name="form[whatRadioListen2]" type="checkbox" value="4"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen24">4. Минская Волна 97,4</label><br></div>
                        <div id="formwhatRadioListen25Div" hidden><input id="formwhatRadioListen25" name="form[whatRadioListen2]" type="checkbox" value="5"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen25">5. Новое Радио 98,4</label><br></div>
                        <div id="formwhatRadioListen26Div" hidden><input id="formwhatRadioListen26" name="form[whatRadioListen2]" type="checkbox" value="6"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen26">6. Русское Радио Минск 98,9</label><br></div>
                        <div id="formwhatRadioListen27Div" hidden><input id="formwhatRadioListen27" name="form[whatRadioListen2]" type="checkbox" value="7"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen27">7. Радио UNISTAR 99,5</label><br></div>
                        <div id="formwhatRadioListen28Div" hidden><input id="formwhatRadioListen28" name="form[whatRadioListen2]" type="checkbox" value="8"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen28">8. Хит-Радио 100,4</label><br></div>
                        ...
                        <div id="formwhatRadioListen210Div" hidden><input id="formwhatRadioListen210" name="form[whatRadioListen2]" type="checkbox" value="10"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen210">10. Радио ОНТ 101,7</label><br></div>
                        <div id="formwhatRadioListen211Div" hidden><input id="formwhatRadioListen211" name="form[whatRadioListen2]" type="checkbox" value="11"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen211">11. Радио РОКС 102,1</label><br></div>
                        <div id="formwhatRadioListen212Div" hidden><input id="formwhatRadioListen212" name="form[whatRadioListen2]" type="checkbox" value="12"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen212">12. Народное радио 102,5</label><br></div>
                        <div id="formwhatRadioListen213Div" hidden><input id="formwhatRadioListen213" name="form[whatRadioListen2]" type="checkbox" value="13"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen213">13. Культура 102,9</label><br></div>
                        <div id="formwhatRadioListen214Div" hidden><input id="formwhatRadioListen214" name="form[whatRadioListen2]" type="checkbox" value="14"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen214">14. Радиус FM 103,7</label><br></div>
                        <div id="formwhatRadioListen215Div" hidden><input id="formwhatRadioListen215" name="form[whatRadioListen2]" type="checkbox" value="15"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen215">15. Радио Би-Эй 104,6</label><br></div>
                        <div id="formwhatRadioListen216Div" hidden><input id="formwhatRadioListen216" name="form[whatRadioListen2]" type="checkbox" value="16"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen216">16. Столица 105,1</label><br></div>
                        <div id="formwhatRadioListen217Div" hidden><input id="formwhatRadioListen217" name="form[whatRadioListen2]" type="checkbox" value="17"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen217">17. Душевное радио 105,7</label><br></div>
                        <div id="formwhatRadioListen218Div" hidden><input id="formwhatRadioListen218" name="form[whatRadioListen2]" type="checkbox" value="18"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen218">18. 1-й Национальный канал белорусского радио 106,2</label><br></div>
                        <div id="formwhatRadioListen219Div" hidden><input id="formwhatRadioListen219" name="form[whatRadioListen2]" type="checkbox" value="19"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen219">19. Легенды FM 94,1</label><br></div>
                        <div id="formwhatRadioListen220Div" hidden><input id="formwhatRadioListen220" name="form[whatRadioListen2]" type="checkbox" value="20"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen220">20. Радио Мир 107,1</label><br></div>
                        <div id="formwhatRadioListen221Div" hidden><input id="formwhatRadioListen221" name="form[whatRadioListen2]" type="checkbox" value="21"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen221">21. Альфа радио 107,9</label><br></div>
                        <div id="formwhatRadioListen222Div" hidden><input id="formwhatRadioListen222" name="form[whatRadioListen2]" type="checkbox" value="23"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen222">23. Город FM (Брест) 97,7</label><br></div>
                        <div id="formwhatRadioListen223Div" hidden><input id="formwhatRadioListen223" name="form[whatRadioListen2]" type="checkbox" value="24"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen223">24. Радио Брест 104,8</label><br></div>
                        <div id="formwhatRadioListen224Div" hidden><input id="formwhatRadioListen224" name="form[whatRadioListen2]" type="checkbox" value="25"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen224">25. Русское Радио Витебск 89,5</label><br></div>
                        <div id="formwhatRadioListen225Div" hidden><input id="formwhatRadioListen225" name="form[whatRadioListen2]" type="checkbox" value="26"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen225">26. Радио Витебск 91,2</label><br></div>
                        <div id="formwhatRadioListen226Div" hidden><input id="formwhatRadioListen226" name="form[whatRadioListen2]" type="checkbox" value="27"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen226">27. Европа Плюс (Витебск) 97,8</label><br></div>
                        <div id="formwhatRadioListen227Div" hidden><input id="formwhatRadioListen227" name="form[whatRadioListen2]" type="checkbox" value="28"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen227">28. Ретро Люкс FM (Витебск) 104,6</label><br></div>
                        <div id="formwhatRadioListen228Div" hidden><input id="formwhatRadioListen228" name="form[whatRadioListen2]" type="checkbox" value="29"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen228">29. Гомель FM 101,3</label><br></div>
                        <div id="formwhatRadioListen239Div" hidden><input id="formwhatRadioListen229" name="form[whatRadioListen2]" type="checkbox" value="30"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen229">30. Гомель Плюс 103,7</label><br></div>
                        <div id="formwhatRadioListen230Div" hidden><input id="formwhatRadioListen230" name="form[whatRadioListen2]" type="checkbox" value="31"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen230">31. Гомельское городское радио 107,4</label><br></div>
                        <div id="formwhatRadioListen232Div" hidden><input id="formwhatRadioListen232" name="form[whatRadioListen2]" type="checkbox" value="32"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen232">32. Радио Гродно 101,2</label><br></div>
                        <div id="formwhatRadioListen233Div" hidden><input id="formwhatRadioListen233" name="form[whatRadioListen2]" type="checkbox" value="33"><input type="hidden" name="_form[whatRadioListen2]" value="on"><label for="formwhatRadioListen233">33. Радио MFM (Гродно) 105,0</label><br></div>
                ...
                <div id="yesterdayListen3Div" hidden>
                    ...
                    <div id="whatRadioListen3">
                        ...
                        <div id="formwhatRadioListen34Div" hidden><input id="formwhatRadioListen34" name="form[whatRadioListen3]" type="checkbox" value="4"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen34">4. Минская Волна 97,4</label><br></div>
                        <div id="formwhatRadioListen35Div" hidden><input id="formwhatRadioListen35" name="form[whatRadioListen3]" type="checkbox" value="5"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen35">5. Новое Радио 98,4</label><br></div>
                        <div id="formwhatRadioListen36Div" hidden><input id="formwhatRadioListen36" name="form[whatRadioListen3]" type="checkbox" value="6"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen36">6. Русское Радио Минск 98,9</label><br></div>
                        <div id="formwhatRadioListen37Div" hidden><input id="formwhatRadioListen37" name="form[whatRadioListen3]" type="checkbox" value="7"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen37">7. Радио UNISTAR 99,5</label><br></div>
                        <div id="formwhatRadioListen38Div" hidden><input id="formwhatRadioListen38" name="form[whatRadioListen3]" type="checkbox" value="8"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen38">8. Хит-Радио 100,4</label><br></div>
                        ...
                        <div id="formwhatRadioListen310Div" hidden><input id="formwhatRadioListen310" name="form[whatRadioListen3]" type="checkbox" value="10"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen310">10. Радио ОНТ 101,7</label><br></div>
                        <div id="formwhatRadioListen311Div" hidden><input id="formwhatRadioListen311" name="form[whatRadioListen3]" type="checkbox" value="11"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen311">11. Радио РОКС 102,1</label><br></div>
                        <div id="formwhatRadioListen312Div" hidden><input id="formwhatRadioListen312" name="form[whatRadioListen3]" type="checkbox" value="12"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen312">12. Народное радио 102,5</label><br></div>
                        <div id="formwhatRadioListen313Div" hidden><input id="formwhatRadioListen313" name="form[whatRadioListen3]" type="checkbox" value="13"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen313">13. Культура 102,9</label><br></div>
                        <div id="formwhatRadioListen314Div" hidden><input id="formwhatRadioListen314" name="form[whatRadioListen3]" type="checkbox" value="14"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen314">14. Радиус FM 103,7</label><br></div>
                        <div id="formwhatRadioListen315Div" hidden><input id="formwhatRadioListen315" name="form[whatRadioListen3]" type="checkbox" value="15"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen315">15. Радио Би-Эй 104,6</label><br></div>
                        <div id="formwhatRadioListen316Div" hidden><input id="formwhatRadioListen316" name="form[whatRadioListen3]" type="checkbox" value="16"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen316">16. Столица 105,1</label><br></div>
                        <div id="formwhatRadioListen317Div" hidden><input id="formwhatRadioListen317" name="form[whatRadioListen3]" type="checkbox" value="17"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen317">17. Душевное радио 105,7</label><br></div>
                        <div id="formwhatRadioListen318Div" hidden><input id="formwhatRadioListen318" name="form[whatRadioListen3]" type="checkbox" value="18"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen318">18. 1-й Национальный канал белорусского радио 106,2</label><br></div>
                        <div id="formwhatRadioListen319Div" hidden><input id="formwhatRadioListen319" name="form[whatRadioListen3]" type="checkbox" value="19"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen319">19. Легенды FM 94,1</label><br></div>
                        <div id="formwhatRadioListen320Div" hidden><input id="formwhatRadioListen320" name="form[whatRadioListen3]" type="checkbox" value="20"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen320">20. Радио Мир 107,1</label><br></div>
                        <div id="formwhatRadioListen321Div" hidden><input id="formwhatRadioListen321" name="form[whatRadioListen3]" type="checkbox" value="21"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen321">21. Альфа радио 107,9</label><br></div>
                        <div id="formwhatRadioListen322Div" hidden><input id="formwhatRadioListen322" name="form[whatRadioListen3]" type="checkbox" value="23"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen322">23. Город FM (Брест) 97,7</label><br></div>
                        <div id="formwhatRadioListen323Div" hidden><input id="formwhatRadioListen323" name="form[whatRadioListen3]" type="checkbox" value="24"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen323">24. Радио Брест 104,8</label><br></div>
                        <div id="formwhatRadioListen324Div" hidden><input id="formwhatRadioListen324" name="form[whatRadioListen3]" type="checkbox" value="25"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen324">25. Русское Радио Витебск 89,5</label><br></div>
                        <div id="formwhatRadioListen325Div" hidden><input id="formwhatRadioListen325" name="form[whatRadioListen3]" type="checkbox" value="26"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen325">26. Радио Витебск 91,2</label><br></div>
                        <div id="formwhatRadioListen326Div" hidden><input id="formwhatRadioListen326" name="form[whatRadioListen3]" type="checkbox" value="27"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen326">27. Европа Плюс (Витебск) 97,8</label><br></div>
                        <div id="formwhatRadioListen327Div" hidden><input id="formwhatRadioListen327" name="form[whatRadioListen3]" type="checkbox" value="28"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen327">28. Ретро Люкс FM (Витебск) 104,6</label><br></div>
                        <div id="formwhatRadioListen328Div" hidden><input id="formwhatRadioListen328" name="form[whatRadioListen3]" type="checkbox" value="29"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen328">29. Гомель FM 101,3</label><br></div>
                        <div id="formwhatRadioListen339Div" hidden><input id="formwhatRadioListen329" name="form[whatRadioListen3]" type="checkbox" value="30"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen329">30. Гомель Плюс 103,7</label><br></div>
                        <div id="formwhatRadioListen330Div" hidden><input id="formwhatRadioListen330" name="form[whatRadioListen3]" type="checkbox" value="31"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen330">31. Гомельское городское радио 107,4</label><br></div>
                        <div id="formwhatRadioListen332Div" hidden><input id="formwhatRadioListen332" name="form[whatRadioListen3]" type="checkbox" value="32"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen332">32. Радио Гродно 101,2</label><br></div>
                        <div id="formwhatRadioListen333Div" hidden><input id="formwhatRadioListen333" name="form[whatRadioListen3]" type="checkbox" value="33"><input type="hidden" name="_form[whatRadioListen3]" value="on"><label for="formwhatRadioListen333">33. Радио MFM (Гродно) 105,0</label><br></div>
                ...
                <div id="yesterdayListen4Div" hidden>
                    ...
                    <div id="whatRadioListen4">
                        ...
                        <div id="formwhatRadioListen44Div" hidden><input id="formwhatRadioListen44" name="form[whatRadioListen4]" type="checkbox" value="4"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen44">4. Минская Волна 97,4</label><br></div>
                        <div id="formwhatRadioListen45Div" hidden><input id="formwhatRadioListen45" name="form[whatRadioListen4]" type="checkbox" value="5"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen45">5. Новое Радио 98,4</label><br></div>
                        <div id="formwhatRadioListen46Div" hidden><input id="formwhatRadioListen46" name="form[whatRadioListen4]" type="checkbox" value="6"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen46">6. Русское Радио Минск 98,9</label><br></div>
                        <div id="formwhatRadioListen47Div" hidden><input id="formwhatRadioListen47" name="form[whatRadioListen4]" type="checkbox" value="7"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen47">7. Радио UNISTAR 99,5</label><br></div>
                        <div id="formwhatRadioListen48Div" hidden><input id="formwhatRadioListen48" name="form[whatRadioListen4]" type="checkbox" value="8"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen48">8. Хит-Радио 100,4</label><br></div>
                        ...
                        <div id="formwhatRadioListen410Div" hidden><input id="formwhatRadioListen410" name="form[whatRadioListen4]" type="checkbox" value="10"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen410">10. Радио ОНТ 101,7</label><br></div>
                        <div id="formwhatRadioListen411Div" hidden><input id="formwhatRadioListen411" name="form[whatRadioListen4]" type="checkbox" value="11"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen411">11. Радио РОКС 102,1</label><br></div>
                        <div id="formwhatRadioListen412Div" hidden><input id="formwhatRadioListen412" name="form[whatRadioListen4]" type="checkbox" value="12"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen412">12. Народное радио 102,5</label><br></div>
                        <div id="formwhatRadioListen413Div" hidden><input id="formwhatRadioListen413" name="form[whatRadioListen4]" type="checkbox" value="13"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen413">13. Культура 102,9</label><br></div>
                        <div id="formwhatRadioListen414Div" hidden><input id="formwhatRadioListen414" name="form[whatRadioListen4]" type="checkbox" value="14"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen414">14. Радиус FM 103,7</label><br></div>
                        <div id="formwhatRadioListen415Div" hidden><input id="formwhatRadioListen415" name="form[whatRadioListen4]" type="checkbox" value="15"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen415">15. Радио Би-Эй 104,6</label><br></div>
                        <div id="formwhatRadioListen416Div" hidden><input id="formwhatRadioListen416" name="form[whatRadioListen4]" type="checkbox" value="16"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen416">16. Столица 105,1</label><br></div>
                        <div id="formwhatRadioListen417Div" hidden><input id="formwhatRadioListen417" name="form[whatRadioListen4]" type="checkbox" value="17"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen417">17. Душевное радио 105,7</label><br></div>
                        <div id="formwhatRadioListen418Div" hidden><input id="formwhatRadioListen418" name="form[whatRadioListen4]" type="checkbox" value="18"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen418">18. 1-й Национальный канал белорусского радио 106,2</label><br></div>
                        <div id="formwhatRadioListen419Div" hidden><input id="formwhatRadioListen419" name="form[whatRadioListen4]" type="checkbox" value="19"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen419">19. Легенды FM 94,1</label><br></div>
                        <div id="formwhatRadioListen420Div" hidden><input id="formwhatRadioListen420" name="form[whatRadioListen4]" type="checkbox" value="20"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen420">20. Радио Мир 107,1</label><br></div>
                        <div id="formwhatRadioListen421Div" hidden><input id="formwhatRadioListen421" name="form[whatRadioListen4]" type="checkbox" value="21"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen421">21. Альфа радио 107,9</label><br></div>
                        <div id="formwhatRadioListen422Div" hidden><input id="formwhatRadioListen422" name="form[whatRadioListen4]" type="checkbox" value="23"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen422">23. Город FM (Брест) 97,7</label><br></div>
                        <div id="formwhatRadioListen423Div" hidden><input id="formwhatRadioListen423" name="form[whatRadioListen4]" type="checkbox" value="24"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen423">24. Радио Брест 104,8</label><br></div>
                        <div id="formwhatRadioListen424Div" hidden><input id="formwhatRadioListen424" name="form[whatRadioListen4]" type="checkbox" value="25"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen424">25. Русское Радио Витебск 89,5</label><br></div>
                        <div id="formwhatRadioListen425Div" hidden><input id="formwhatRadioListen425" name="form[whatRadioListen4]" type="checkbox" value="26"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen425">26. Радио Витебск 91,2</label><br></div>
                        <div id="formwhatRadioListen426Div" hidden><input id="formwhatRadioListen426" name="form[whatRadioListen4]" type="checkbox" value="27"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen426">27. Европа Плюс (Витебск) 97,8</label><br></div>
                        <div id="formwhatRadioListen427Div" hidden><input id="formwhatRadioListen427" name="form[whatRadioListen4]" type="checkbox" value="28"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen427">28. Ретро Люкс FM (Витебск) 104,6</label><br></div>
                        <div id="formwhatRadioListen428Div" hidden><input id="formwhatRadioListen428" name="form[whatRadioListen4]" type="checkbox" value="29"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen428">29. Гомель FM 101,3</label><br></div>
                        <div id="formwhatRadioListen439Div" hidden><input id="formwhatRadioListen429" name="form[whatRadioListen4]" type="checkbox" value="30"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen429">30. Гомель Плюс 103,7</label><br></div>
                        <div id="formwhatRadioListen430Div" hidden><input id="formwhatRadioListen430" name="form[whatRadioListen4]" type="checkbox" value="31"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen430">31. Гомельское городское радио 107,4</label><br></div>
                        <div id="formwhatRadioListen432Div" hidden><input id="formwhatRadioListen432" name="form[whatRadioListen4]" type="checkbox" value="32"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen432">32. Радио Гродно 101,2</label><br></div>
                        <div id="formwhatRadioListen433Div" hidden><input id="formwhatRadioListen433" name="form[whatRadioListen4]" type="checkbox" value="33"><input type="hidden" name="_form[whatRadioListen4]" value="on"><label for="formwhatRadioListen433">33. Радио MFM (Гродно) 105,0</label><br></div>
                ...
                <div id="yesterdayListen5Div" hidden>
                    ...
                    <div id="whatRadioListen5">
                        ...
                        <div id="formwhatRadioListen54Div" hidden><input id="formwhatRadioListen54" name="form[whatRadioListen5]" type="checkbox" value="4"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen54">4. Минская Волна 97,4</label><br></div>
                        <div id="formwhatRadioListen55Div" hidden><input id="formwhatRadioListen55" name="form[whatRadioListen5]" type="checkbox" value="5"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen55">5. Новое Радио 98,4</label><br></div>
                        <div id="formwhatRadioListen56Div" hidden><input id="formwhatRadioListen56" name="form[whatRadioListen5]" type="checkbox" value="6"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen56">6. Русское Радио Минск 98,9</label><br></div>
                        <div id="formwhatRadioListen57Div" hidden><input id="formwhatRadioListen57" name="form[whatRadioListen5]" type="checkbox" value="7"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen57">7. Радио UNISTAR 99,5</label><br></div>
                        <div id="formwhatRadioListen58Div" hidden><input id="formwhatRadioListen58" name="form[whatRadioListen5]" type="checkbox" value="8"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen58">8. Хит-Радио 100,4</label><br></div>
                        ...
                        <div id="formwhatRadioListen510Div" hidden><input id="formwhatRadioListen510" name="form[whatRadioListen5]" type="checkbox" value="10"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen510">10. Радио ОНТ 101,7</label><br></div>
                        <div id="formwhatRadioListen511Div" hidden><input id="formwhatRadioListen511" name="form[whatRadioListen5]" type="checkbox" value="11"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen511">11. Радио РОКС 102,1</label><br></div>
                        <div id="formwhatRadioListen512Div" hidden><input id="formwhatRadioListen512" name="form[whatRadioListen5]" type="checkbox" value="12"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen512">12. Народное радио 102,5</label><br></div>
                        <div id="formwhatRadioListen513Div" hidden><input id="formwhatRadioListen513" name="form[whatRadioListen5]" type="checkbox" value="13"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen513">13. Культура 102,9</label><br></div>
                        <div id="formwhatRadioListen514Div" hidden><input id="formwhatRadioListen514" name="form[whatRadioListen5]" type="checkbox" value="14"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen514">14. Радиус FM 103,7</label><br></div>
                        <div id="formwhatRadioListen515Div" hidden><input id="formwhatRadioListen515" name="form[whatRadioListen5]" type="checkbox" value="15"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen515">15. Радио Би-Эй 104,6</label><br></div>
                        <div id="formwhatRadioListen516Div" hidden><input id="formwhatRadioListen516" name="form[whatRadioListen5]" type="checkbox" value="16"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen516">16. Столица 105,1</label><br></div>
                        <div id="formwhatRadioListen517Div" hidden><input id="formwhatRadioListen517" name="form[whatRadioListen5]" type="checkbox" value="17"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen517">17. Душевное радио 105,7</label><br></div>
                        <div id="formwhatRadioListen518Div" hidden><input id="formwhatRadioListen518" name="form[whatRadioListen5]" type="checkbox" value="18"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen518">18. 1-й Национальный канал белорусского радио 106,2</label><br></div>
                        <div id="formwhatRadioListen519Div" hidden><input id="formwhatRadioListen519" name="form[whatRadioListen5]" type="checkbox" value="19"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen519">19. Легенды FM 94,1</label><br></div>
                        <div id="formwhatRadioListen520Div" hidden><input id="formwhatRadioListen520" name="form[whatRadioListen5]" type="checkbox" value="20"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen520">20. Радио Мир 107,1</label><br></div>
                        <div id="formwhatRadioListen521Div" hidden><input id="formwhatRadioListen521" name="form[whatRadioListen5]" type="checkbox" value="21"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen521">21. Альфа радио 107,9</label><br></div>
                        <div id="formwhatRadioListen522Div" hidden><input id="formwhatRadioListen522" name="form[whatRadioListen5]" type="checkbox" value="23"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen522">23. Город FM (Брест) 97,7</label><br></div>
                        <div id="formwhatRadioListen523Div" hidden><input id="formwhatRadioListen523" name="form[whatRadioListen5]" type="checkbox" value="24"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen523">24. Радио Брест 104,8</label><br></div>
                        <div id="formwhatRadioListen524Div" hidden><input id="formwhatRadioListen524" name="form[whatRadioListen5]" type="checkbox" value="25"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen524">25. Русское Радио Витебск 89,5</label><br></div>
                        <div id="formwhatRadioListen525Div" hidden><input id="formwhatRadioListen525" name="form[whatRadioListen5]" type="checkbox" value="26"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen525">26. Радио Витебск 91,2</label><br></div>
                        <div id="formwhatRadioListen526Div" hidden><input id="formwhatRadioListen526" name="form[whatRadioListen5]" type="checkbox" value="27"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen526">27. Европа Плюс (Витебск) 97,8</label><br></div>
                        <div id="formwhatRadioListen527Div" hidden><input id="formwhatRadioListen527" name="form[whatRadioListen5]" type="checkbox" value="28"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen527">28. Ретро Люкс FM (Витебск) 104,6</label><br></div>
                        <div id="formwhatRadioListen528Div" hidden><input id="formwhatRadioListen528" name="form[whatRadioListen5]" type="checkbox" value="29"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen528">29. Гомель FM 101,3</label><br></div>
                        <div id="formwhatRadioListen539Div" hidden><input id="formwhatRadioListen529" name="form[whatRadioListen5]" type="checkbox" value="30"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen529">30. Гомель Плюс 103,7</label><br></div>
                        <div id="formwhatRadioListen530Div" hidden><input id="formwhatRadioListen530" name="form[whatRadioListen5]" type="checkbox" value="31"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen530">31. Гомельское городское радио 107,4</label><br></div>
                        <div id="formwhatRadioListen532Div" hidden><input id="formwhatRadioListen532" name="form[whatRadioListen5]" type="checkbox" value="32"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen532">32. Радио Гродно 101,2</label><br></div>
                        <div id="formwhatRadioListen533Div" hidden><input id="formwhatRadioListen533" name="form[whatRadioListen5]" type="checkbox" value="33"><input type="hidden" name="_form[whatRadioListen5]" value="on"><label for="formwhatRadioListen533">33. Радио MFM (Гродно) 105,0</label><br></div>
                ...
                <div id="yesterdayListen6Div" hidden>
                    ...
                    <div id="whatRadioListen6">
                        ...
                        <div id="formwhatRadioListen64Div" hidden><input id="formwhatRadioListen64" name="form[whatRadioListen6]" type="checkbox" value="4"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen64">4. Минская Волна 97,4</label><br></div>
                        <div id="formwhatRadioListen65Div" hidden><input id="formwhatRadioListen65" name="form[whatRadioListen6]" type="checkbox" value="5"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen65">5. Новое Радио 98,4</label><br></div>
                        <div id="formwhatRadioListen66Div" hidden><input id="formwhatRadioListen66" name="form[whatRadioListen6]" type="checkbox" value="6"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen66">6. Русское Радио Минск 98,9</label><br></div>
                        <div id="formwhatRadioListen67Div" hidden><input id="formwhatRadioListen67" name="form[whatRadioListen6]" type="checkbox" value="7"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen67">7. Радио UNISTAR 99,5</label><br></div>
                        <div id="formwhatRadioListen68Div" hidden><input id="formwhatRadioListen68" name="form[whatRadioListen6]" type="checkbox" value="8"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen68">8. Хит-Радио 100,4</label><br></div>
                        ...
                        <div id="formwhatRadioListen610Div" hidden><input id="formwhatRadioListen610" name="form[whatRadioListen6]" type="checkbox" value="10"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen610">10. Радио ОНТ 101,7</label><br></div>
                        <div id="formwhatRadioListen611Div" hidden><input id="formwhatRadioListen611" name="form[whatRadioListen6]" type="checkbox" value="11"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen611">11. Радио РОКС 102,1</label><br></div>
                        <div id="formwhatRadioListen612Div" hidden><input id="formwhatRadioListen612" name="form[whatRadioListen6]" type="checkbox" value="12"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen612">12. Народное радио 102,5</label><br></div>
                        <div id="formwhatRadioListen613Div" hidden><input id="formwhatRadioListen613" name="form[whatRadioListen6]" type="checkbox" value="13"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen613">13. Культура 102,9</label><br></div>
                        <div id="formwhatRadioListen614Div" hidden><input id="formwhatRadioListen614" name="form[whatRadioListen6]" type="checkbox" value="14"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen614">14. Радиус FM 103,7</label><br></div>
                        <div id="formwhatRadioListen615Div" hidden><input id="formwhatRadioListen615" name="form[whatRadioListen6]" type="checkbox" value="15"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen615">15. Радио Би-Эй 104,6</label><br></div>
                        <div id="formwhatRadioListen616Div" hidden><input id="formwhatRadioListen616" name="form[whatRadioListen6]" type="checkbox" value="16"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen616">16. Столица 105,1</label><br></div>
                        <div id="formwhatRadioListen617Div" hidden><input id="formwhatRadioListen617" name="form[whatRadioListen6]" type="checkbox" value="17"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen617">17. Душевное радио 105,7</label><br></div>
                        <div id="formwhatRadioListen618Div" hidden><input id="formwhatRadioListen618" name="form[whatRadioListen6]" type="checkbox" value="18"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen618">18. 1-й Национальный канал белорусского радио 106,2</label><br></div>
                        <div id="formwhatRadioListen619Div" hidden><input id="formwhatRadioListen619" name="form[whatRadioListen6]" type="checkbox" value="19"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen619">19. Легенды FM 94,1</label><br></div>
                        <div id="formwhatRadioListen620Div" hidden><input id="formwhatRadioListen620" name="form[whatRadioListen6]" type="checkbox" value="20"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen620">20. Радио Мир 107,1</label><br></div>
                        <div id="formwhatRadioListen621Div" hidden><input id="formwhatRadioListen621" name="form[whatRadioListen6]" type="checkbox" value="21"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen621">21. Альфа радио 107,9</label><br></div>
                        <div id="formwhatRadioListen622Div" hidden><input id="formwhatRadioListen622" name="form[whatRadioListen6]" type="checkbox" value="23"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen622">23. Город FM (Брест) 97,7</label><br></div>
                        <div id="formwhatRadioListen623Div" hidden><input id="formwhatRadioListen623" name="form[whatRadioListen6]" type="checkbox" value="24"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen623">24. Радио Брест 104,8</label><br></div>
                        <div id="formwhatRadioListen624Div" hidden><input id="formwhatRadioListen624" name="form[whatRadioListen6]" type="checkbox" value="25"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen624">25. Русское Радио Витебск 89,5</label><br></div>
                        <div id="formwhatRadioListen625Div" hidden><input id="formwhatRadioListen625" name="form[whatRadioListen6]" type="checkbox" value="26"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen625">26. Радио Витебск 91,2</label><br></div>
                        <div id="formwhatRadioListen626Div" hidden><input id="formwhatRadioListen626" name="form[whatRadioListen6]" type="checkbox" value="27"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen626">27. Европа Плюс (Витебск) 97,8</label><br></div>
                        <div id="formwhatRadioListen627Div" hidden><input id="formwhatRadioListen627" name="form[whatRadioListen6]" type="checkbox" value="28"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen627">28. Ретро Люкс FM (Витебск) 104,6</label><br></div>
                        <div id="formwhatRadioListen628Div" hidden><input id="formwhatRadioListen628" name="form[whatRadioListen6]" type="checkbox" value="29"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen628">29. Гомель FM 101,3</label><br></div>
                        <div id="formwhatRadioListen639Div" hidden><input id="formwhatRadioListen629" name="form[whatRadioListen6]" type="checkbox" value="30"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen629">30. Гомель Плюс 103,7</label><br></div>
                        <div id="formwhatRadioListen630Div" hidden><input id="formwhatRadioListen630" name="form[whatRadioListen6]" type="checkbox" value="31"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen630">31. Гомельское городское радио 107,4</label><br></div>
                        <div id="formwhatRadioListen632Div" hidden><input id="formwhatRadioListen632" name="form[whatRadioListen6]" type="checkbox" value="32"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen632">32. Радио Гродно 101,2</label><br></div>
                        <div id="formwhatRadioListen633Div" hidden><input id="formwhatRadioListen633" name="form[whatRadioListen6]" type="checkbox" value="33"><input type="hidden" name="_form[whatRadioListen6]" value="on"><label for="formwhatRadioListen633">33. Радио MFM (Гродно) 105,0</label><br></div>
